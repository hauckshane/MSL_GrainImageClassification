...
kable(accuracy_scores %>% arrange(desc(Accuracy)))
```
...
kable(boot_accuracy_scores %>% arrange(desc(Boot_Accuracy)))

```

```{r, echo=FALSE, fig.align='center', fig.cap='Ridge plots showing distributions of Bootstrapped Accuracy Scores'}}
...
rbind(data.frame(Variable = "Lasso", "Accuracy" = boot_lasso_acc),
      ...
      data.frame(Variable = "Quadratic Discriminant Analysis", "Accuracy" = boot_qda_acc)) -> boot_df
